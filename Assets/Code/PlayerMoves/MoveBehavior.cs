...
public abstract class MoveBehavior : MonoBehaviour {
    ...
    abstract public void Init();                            // set up internal move logic
    public virtual bool IsExclusive(){ return false; }		// this move ignores effects of following moves in the list
	public virtual bool ZeroMovement(){ return false; }	    // this sets the velocity at 0,0 before applying affects
