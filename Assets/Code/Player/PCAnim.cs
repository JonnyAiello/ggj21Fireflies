...
public class PCAnim : MonoBehaviour {
    ...
    public void AnimUpdate(){
        ...
        switch( aState ){
    		...
    		case State.BoxIdle:
    			if( transition && anim.GetCurrentAnimatorStateInfo(0).IsName("BoxIdle")){
    		...
    		case State.BoxWalk:
                if( transition 
                    && anim.GetCurrentAnimatorStateInfo(0).IsName("BoxWalk")){
